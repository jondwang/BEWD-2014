...
#2 - Great, what if we wanted to multiply 22*44 again. If we had to type that out each time, it would be inefficient
...
###########
gets
#Prompts user to type in a string and returns the string
